...
function EditCustomerInfo() {
  ...
  const { data, isError, isLoading } = useQuery(
    ["customerEditData", customerSeq],
    () => getCustomerEditData(customerSeq)
  );
                ...
                <FaceBox>
                  {data.faceDict.map((type, index) => (
                    <FaceSet>
                      ...
                      <FaceImg
                        src={`https://i9b111.q.ssafy.io/api/customer-profile/face_dict/${face[index]}`}
                      ></FaceImg>
                      ...
                      <FaceBtn
                        ...
                        whileHover="hover"
                        animate={
                          selectedFaceType === type.seq ? "active" : "normal"
                        }
                      >
                        {type.faceLabel}
                      </FaceBtn>
              ...
              <HairBox>
                ...
                {data.hairConditionDict.map((type) => (
                  <HairBtn
                    ...
                    whileHover="hover"
                    animate={
                      selectedHairTypes.includes(type.seq) ? "active" : "normal"
                    }
                  >
                    {type.label}
                  </HairBtn>
